...
def _get_dis_params(data_key):
    ...
    dis_params = {'input' : [1, 16, 32, 64],
                 'output' : [16, 32, 64, 128]}
    
    dis_params['kernel'] = [(3, 3), (3, 3), (3, 3), (3, 3)]
    dis_params['stride'] = [1, 1, 1, 1]
    dis_params['padding'] = [(1, 1), (1, 1), (1, 1), (1, 1)]
...
def _get_gen_params(data_key):
    ...
    gen_params['kernel'] = [(3, 3), (3, 3), (3, 3), (3, 3)]
    gen_params['stride'] = [1, 1, 1, (2, 1)]
    gen_params['padding'] = [(1, 1), (1, 1), (1, 1), (1, 1)]
